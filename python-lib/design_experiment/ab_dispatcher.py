...
class AbDispatcher(object):
    ...
    def dispatch(self, input_df: pd.DataFrame, reference_column: str, attribution: AttributionMethod) -> tuple:
        ...
        group_df = self.split_into_groups(population_df, attribution)
        return group_df
    ...
    def split_into_groups(self, population_df: pd.DataFrame, attribution_method: AttributionMethod) -> tuple:
